		...
		rows:[
			{
				...
				columns:[
					...
					{id:"nodecode", header:"节点编号", sort:"string",width:100,css:'bgcolor1'},
					...
					{id:"nnnetproctime", header:"净处理时间", editor:"text",width:85,css:'bgcolor1'},
                     {id:"nnbuffertime", header:"缓冲时间", editor:"text",width:85,css:'bgcolor1'},
                     {id:"nnstateupdatefreq", header:"更新间隔", editor:"text",width:85,css:'bgcolor1'},
